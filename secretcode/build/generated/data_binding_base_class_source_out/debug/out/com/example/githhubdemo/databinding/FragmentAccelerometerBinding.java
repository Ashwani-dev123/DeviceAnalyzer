...
public final class FragmentAccelerometerBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentAccelerometerBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentAccelerometerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentAccelerometerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_accelerometer, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentAccelerometerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAccelerometerBinding((ConstraintLayout) rootView, btnNo, btnYes, llButtons,
          tvDetails);
    }
