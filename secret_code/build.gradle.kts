...
//        versionName = "1.0"
    ...
    // Fix 1: Use only one externalNativeBuild block with proper CMake version
    externalNativeBuild {
        cmake {
            path = file("../secret_code/src/main/cpp/CMakeLists.txt")
            version = "3.22.1"  // Changed from 4.0.2 to a stable version available in Android SDK
        }
    }
    ...
    // Fix 2: Fixed splits configuration syntax
    splits {
        abi {
            isEnable = true
            reset()
