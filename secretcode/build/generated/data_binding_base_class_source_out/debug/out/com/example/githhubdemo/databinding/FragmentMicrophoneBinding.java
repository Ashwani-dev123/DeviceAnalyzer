...
public final class FragmentMicrophoneBinding implements ViewBinding {
  ...
  private FragmentMicrophoneBinding(@NonNull ConstraintLayout rootView, @NonNull LinearLayout btnNo,
      @NonNull LinearLayout btnYes, @NonNull ImageView ivMicrophone,
  ...
  public static FragmentMicrophoneBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMicrophoneBinding((ConstraintLayout) rootView, btnNo, btnYes, ivMicrophone,
          llButtons, progressBar, tvDetails);
    }
