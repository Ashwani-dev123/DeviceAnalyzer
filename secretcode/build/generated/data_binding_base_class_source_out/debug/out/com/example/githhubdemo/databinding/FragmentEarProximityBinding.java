...
public final class FragmentEarProximityBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentEarProximityBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentEarProximityBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentEarProximityBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_ear_proximity, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentEarProximityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentEarProximityBinding((ConstraintLayout) rootView, btnNo, btnYes, llButtons,
          tvDetails);
    }
