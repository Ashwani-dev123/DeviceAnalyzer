...
public final class FragmentLoudSpeakerBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentLoudSpeakerBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentLoudSpeakerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentLoudSpeakerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_loud_speaker, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentLoudSpeakerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentLoudSpeakerBinding((ConstraintLayout) rootView, btnNo, btnYes, llButtons,
          tvDetails);
    }
