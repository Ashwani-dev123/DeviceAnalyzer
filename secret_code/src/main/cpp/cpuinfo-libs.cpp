...
extern "C"
__attribute__((unused)) JNIEXPORT jintArray JNICALL
...
Java_com_example_githhubdemo_deviceinfo_data_provider_CpuDataProvider_initLibrary(JNIEnv *env,
                                                                                      jobject thiz) {
...
Java_com_example_githhubdemo_deviceinfo_data_provider_CpuDataProvider_getCpuName(JNIEnv *env,
                                                                                     jobject thiz) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_example_githhubdemo_deviceinfo_data_provider_CpuDataProvider_hasArmNeon(JNIEnv *env,
                                                                                     jobject thiz) {
    if (!cpuinfo_initialize()) {
        return false;
    }
...
Java_com_example_githhubdemo_deviceinfo_data_provider_CpuDataProvider_getL1dCaches(JNIEnv *env,
                                                                                       jobject thiz) {
    if (!cpuinfo_initialize() || cpuinfo_get_l1d_caches_count() == 0) {
        return nullptr;
    }
...
extern "C"
JNIEXPORT jintArray JNICALL
Java_com_example_githhubdemo_deviceinfo_data_provider_CpuDataProvider_getL1iCaches(JNIEnv *env,
                                                                                       jobject thiz) {
    if (!cpuinfo_initialize() || cpuinfo_get_l1i_caches_count() == 0) {
        return nullptr;
    }
...
extern "C"
JNIEXPORT jintArray JNICALL
Java_com_example_githhubdemo_deviceinfo_data_provider_CpuDataProvider_getL2Caches(JNIEnv *env,
                                                                                      jobject thiz) {
...
extern "C"
JNIEXPORT jintArray JNICALL
Java_com_example_githhubdemo_deviceinfo_data_provider_CpuDataProvider_getL3Caches(JNIEnv *env,
                                                                                      jobject thiz) {
...
extern "C"
JNIEXPORT jintArray JNICALL
Java_com_example_githhubdemo_deviceinfo_data_provider_CpuDataProvider_getL4Caches(JNIEnv *env,
                                                                                      jobject thiz) {
